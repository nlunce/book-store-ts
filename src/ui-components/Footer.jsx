    ...
    >
      ...
      >
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Contact3886704")}
        >
          <Text
            fontFamily="Inter"
            fontSize="16px"
            ...
            whiteSpace="pre-wrap"
            children="Contact"
            {...getOverrideProps(overrides, "Contact39413975")}
          ></Text>
        </Flex>
        <Flex
          gap="10px"
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Blog3886712")}
        >
          <Text
            fontFamily="Inter"
            fontSize="16px"
            ...
            whiteSpace="pre-wrap"
            children="Blog"
            {...getOverrideProps(overrides, "Blog39413976")}
          ></Text>
        </Flex>
        <Flex
          gap="10px"
      ...
      >
        ...
        >
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children="© 2023 Luxorum LLC. All rights reserved."
            {...getOverrideProps(
              overrides,
              "\u00A9 2023 Luxorum LLC. All rights reserved."
            )}
          ></Text>
        </View>
      </Flex>
