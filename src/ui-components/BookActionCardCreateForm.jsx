...
import { createBookActionCard } from "../graphql/mutations";
function ArrayField({
  items = [],
  onChange,
  label,
...
export default function BookActionCardCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setIsbn10(initialValues.isbn10);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createBookActionCard.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BookActionCardCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
