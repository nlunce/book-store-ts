...
export default function NavbarLoggedInMobile(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "NavbarLoggedInMobile")}
      {...rest}
    >
      <Flex
        gap="20px"
      ...
      >
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Options39265065")}
        >
          <Text
            fontFamily="Inter"
            fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Options39265072")}
          >
            <View
              width="40px"
              height="5px"
